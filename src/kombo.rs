...
mod parsör {
    ...
    trait Parsör {
        ...
        fn zero_or_more(&self) -> impl Parsör<In = Self::In, Out = Vec<Self::Out>>;
    }
}
    ...
    P: Parser,
{
    ...
    // Can this be re-written to be recursive instead? This ought to seemingly
    // do away with the need for Clone, since I can move into the following call.
    // .. or wait - I cannot.
    fn parse(self, input: ParseState<Self::In>) -> ParseResult<Self::In, Self::Out> {
